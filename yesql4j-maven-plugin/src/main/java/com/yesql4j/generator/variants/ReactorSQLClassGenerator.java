...
public class ReactorSQLClassGenerator implements IClassGenerator {
    ...
    private final List<String> imports = List.of(
            ...
            "com.yesql4j.reactor.Yesql4jReactor",
    ...
    @Override
    public @NotNull String generateClassHeader(@NotNull String className) {
        return "";
    }

    @Override
    public @NotNull List<String> getClassAnnotations() { return Collections.emptyList(); }
