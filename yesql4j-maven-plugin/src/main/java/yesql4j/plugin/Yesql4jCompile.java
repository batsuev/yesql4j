...
import yesql4j.generator.ClassGenerator;
import yesql4j.generator.GenerationTarget;
import yesql4j.generator.NameUtils;
import yesql4j.parser.SQLParser;
...
public final class Yesql4jCompile extends AbstractMojo {
    ...
    private void generateSQL(File sqlSource) throws IOException {
        ...
        var generated = classGenerator.generate(sqlSource.toPath(), sqlSourceRoot.toPath(), queries, GenerationTarget.VERTX_MYSQL_REACTOR);
